...
from app_pages.page_4_hypothesis_validation import page4_hypothesis_validation_body
...
app.app_page("P4 - Hypothesis Validation", page4_hypothesis_validation_body)
