...
def page_5_ml_predict_body():
    ...
    st.info(
        f"* The pipeline was created to satisfy Business Requirement 2 for "
        f"our client. Please see Page 1 of the dashboard as a reminder."
        ...
        f"our model."
        f"In agreement with the client, we have set the following targets as "
        f"a measurement of success.")
    st.info(
